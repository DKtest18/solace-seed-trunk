          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            ...
            <Card className="backdrop-blur-md bg-background/80 border-border/50">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">{t('stats.platformFees') || '10% platform fees'}</p>
              </CardContent>
            </Card>
            ...
            <Card className="backdrop-blur-md bg-background/80 border-border/50">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">{t('stats.paidToSellers') || '90% paid to sellers'}</p>
              </CardContent>
            </Card>
